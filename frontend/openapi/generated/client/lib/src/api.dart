...
import 'package:openapi/src/api/areas_api.dart';
import 'package:openapi/src/api/auth_api.dart';
import 'package:openapi/src/api/batch_api.dart';
import 'package:openapi/src/api/current_api.dart';
...
class Openapi {
  ...
  /// Get CurrentApi instance, base route and serializer can be overridden by a given but be careful,
  /// by doing that all interceptors will not be executed
  CurrentApi getCurrentApi() {
    return CurrentApi(dio, serializers);
  }
